...
impl GitGraph {
        ...
        Some(ContextMenu::build(window, cx, {
            ...
            move |context_menu, _, _| {
                context_menu
                    ...
                    .action("Merge into current branch...", MergeCommit.boxed_clone())
                    .action(
                        format!("Rebase current branch on {}...", branch_name),
                        RebaseOntoCommit.boxed_clone(),
                    )
                    .separator()
                    .action(
    ...
    fn build_tag_context_menu(
        ...
        Some(ContextMenu::build(window, cx, {
            ...
            let tag_name_for_copy = tag_name;
            move |context_menu, _, _| {
                context_menu
                    .context(focus_handle)
                    .action("Checkout...", CheckoutCommit.boxed_clone())
    ...
    fn build_stash_context_menu(
        ...
        Some(ContextMenu::build(window, cx, {
            let stash_name_for_copy = stash_name;
            move |context_menu, _, _| {
                context_menu
                    .context(focus_handle)
                ...
                vec![
                    div()
                        ...
                        .when(!has_context_menu, |this| {
                            this.tooltip(Tooltip::text(subject_for_tooltip))
                        })
                        .child(
                            h_flex()
                                .gap_2()
